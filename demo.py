...
if __name__ == "__main__":
    ...
    if action.startswith("Collect eye-tracking data"):
        try:
            result = subprocess.run(["python", "main.py"], check=True, cwd="src/glassesRecord/")
        ...
        try:
            result = subprocess.run(["python", "main.py"], check=True, cwd="src/centralCam/")
        except subprocess.CalledProcessError as e:
            print(f"Error occurred while running the script")
        ...
        try:
            result = subprocess.run(["python", "main.py"], check=True, cwd="src/offlineInterface")
        except subprocess.CalledProcessError as e:
            print(f"Error occurred while running the script")
